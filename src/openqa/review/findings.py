...
OpenQA 生成骨架 SARIF，Agent 宿主填充实际 findings。
骨架已包含：
...
# SARIF 标准规则 ID
SARIF_RULES = [
    {"id": "OQA001", "name": "RequirementsConsistency",  "shortDescription": "需求一致性",        "level": "warning"},
    {"id": "OQA002", "name": "ImpactScope",              "shortDescription": "影响面覆盖",        "level": "warning"},
    {"id": "OQA003", "name": "BoundaryCondition",        "shortDescription": "边界条件",          "level": "warning"},
    {"id": "OQA004", "name": "ExceptionHandling",        "shortDescription": "异常处理",          "level": "warning"},
    {"id": "OQA005", "name": "ConcurrencyPerformance",   "shortDescription": "并发/性能",         "level": "warning"},
    {"id": "OQA006", "name": "Security",                 "shortDescription": "安全",              "level": "error"},
    {"id": "OQA007", "name": "Testability",              "shortDescription": "可测试性",          "level": "note"},
    {"id": "OQA008", "name": "Maintainability",          "shortDescription": "可维护性",          "level": "note"},
]
        ...
        "runs": [
            {
                "tool": {
                    "driver": {
                        "name": "openqa-review",
                        "version": "0.1.0",
                        "informationUri": "https://github.com/openqa",
                        "rules": rules,
                    }
                },
                "results": findings or [],
