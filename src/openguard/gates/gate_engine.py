...
def evaluate_gate(
    ...
    # 5. 历史记录决策（REQ-08-06）
    history_check = _check_history(gate, openguard_dir, config)
...
def _check_history(
    ...
    index_path = openguard_dir / "reports" / "suites" / suite_name / "suite_index.yaml"
...
def write_gate_report(
    ...
    report: dict[str, Any] = {
        "schema_version": "openguard/gate_report/v1",
